...
//        String  addIntegralUrl ="http://api."+com.iyuba.configation.Constant.IYBHttpHead+"/credits/updateScore.jsp?srid="+srid;
...
//        setAbsoluteURI(url);
//    }
    @GET("http://api."+com.iyuba.configation.Constant.IYBHttpHead+"/credits/updateScore.jsp?mobile=1")
