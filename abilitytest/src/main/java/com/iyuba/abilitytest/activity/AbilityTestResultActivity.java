...
//import com.iyuba.imooclib.microclass.activity.IMoocListActivity;
...
public class AbilityTestResultActivity extends AppBaseActivity {
    ...
    protected void initViews(Bundle savedInstanceState) {
        ...
        String titleName = "我的英语能力(" + mTypeName + ")";
...
//        ShareSDK.initSDK(this);
        ...
        oks.setSiteUrl("http://app."+com.iyuba.configation.Constant.IYBHttpHead+"/android/androidDetail.jsp?id=" + Constant.APPID);
        // 图片的网络路径，新浪微博、人人、QQ空间和Linked-in
        oks.setTitle(Constant.APPName);
        oks.setTitleUrl("http://app."+com.iyuba.configation.Constant.IYBHttpHead+"/android/androidDetail.jsp?id=" + Constant.APPID);
        oks.setFilePath("http://app."+com.iyuba.configation.Constant.IYBHttpHead+"/androidApp.jsp?id=" + Constant.APPID + "&appId=" + Constant.APPID_DOWNLOAD);
        oks.setUrl("http://app."+com.iyuba.configation.Constant.IYBHttpHead+"/androidApp.jsp?id=" + Constant.APPID + "&appId=" + Constant.APPID_DOWNLOAD);
        oks.setText("来挑战我的" + mTypeName + "水平吧~ 我在" + Constant.APPName + "测评中得了" + mTotalScore + " 分。地址:http://app."+com.iyuba.configation.Constant.IYBHttpHead+"/android/androidDetail.jsp?id=" + Constant.APPID);
...
//                intent.setClass(AbilityTestResultActivity.this, IMoocListActivity.class);
                hander.sendEmptyMessage(FINISHSELF);
                startActivity(intent);
            }
        };
