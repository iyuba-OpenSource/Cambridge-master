...
import com.iyuba.abilitytest.utils.GetFileSizeUtils;
...
public class AbilityTestListActivity extends AppBaseActivity {
    ...
    protected void initVariables() {
        ...
        lessonInfos = AbilityDBHelper.getInstance().getLessonInfosByBookId(Constant.APPID);
    ...
    protected void initViews(Bundle savedInstanceState) {
        ...
        deleteCache = findViewById(R.id.iv_delete_cc);
        ...
        adInfoFlowUtil = new AdInfoFlowUtil(mContext, UserinfoManager.getInstance().getVIPSTATUS(), new AdInfoFlowUtil.Callback() {
            @Override
    ...
    private void showAlertDialog() {
        ...
        if (list.size() == 0) {
            ToastUtil.showToast(mContext, "暂无缓存");
            return;
        }
                ...
                .setPositiveButton("删除",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                TestedUtil.removeLessonId(data[cachePosition]);
