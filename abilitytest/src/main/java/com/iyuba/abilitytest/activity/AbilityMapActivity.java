...
import com.iyuba.abilitytest.utils.MD5;
...
public class AbilityMapActivity extends AppBaseActivity {
    ...
    protected void initVariables() {
        ...
        Constant.mListen = AbilityDBHelper.getInstance().getLessonInfosByBookId(Constant.APPID).get(0).bookName;
    ...
    private void initTitlebar() {
        ...
        if (Constant.mListen.equals("IELTS") || Constant.mListen.equals("N1")) {
            ...
            if (flag_mode == FLAG_TEST) {
                tv_titlebar_sub.setText("我的英语能力图谱");
            } else {
    ...
    protected void loadData() {
        ...
        if (flag_mode == 1) {
            ...
            mBtn_speak.setBackgroundResource(R.mipmap.speak_disable);
...
//                gotoTargetClass(AbilityMapSubActivity.class, mSpeakTestResults, Constant.ABILITY_SPEAK);
            ...
            mBtn_write.setBackgroundResource(R.mipmap.write_disable);
    ...
    private View.OnClickListener guideButtonClickListener() {
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("url", " http://app."+com.iyuba.configation.Constant.IYBHttpHead+"/wap/evaluation.jsp");
    ...
    private void gotoTargetClass(Class targetClass, ArrayList arr, String abilityType) {
        ...
        if (b) {
            ...
            if ((Constant.APPID.equals("207") || Constant.APPID.equals("208"))
                ...
                intent.putExtra("lessonId", 0);//unitId
            } else {
                intent.putExtra("lessonId", mLessonId);//unitId
            }
            startActivity(intent);
        } else {
