...
import com.iyuba.abilitytest.utils.RuntimeManager;
...
import static com.iyuba.abilitytest.utils.RuntimeManager.getApplication;
...
public abstract class AppBaseActivity extends BaseActivity {
   ...
   /* public void showAlertDialog(final int cur, int total, final String type, final ArrayList<AbilityQues> mQuesList, final int mode) {
    ...
    protected String getUid() {
        return ConfigManager.Instance().loadString("userId");
//        return AccountManager.Instace(getApplicationContext()).getUserId();
    }
...
//            return isUserLogin()&& (!AccountManager.Instace(getApplicationContext()).userInfo.vipStatus.equals("0") );
            return isUserLogin()&& (UserinfoManager.getInstance().getVIPSTATUS());
