...
public class Player implements OnBufferingUpdateListener, OnCompletionListener,
    ...
    public void play() {
     ...
     OnPlayStateChangedListener a = new OnPlayStateChangedListener() {
         @Override
...
//                        mediaPlayer.setDataSource(audioUrl);
                        Log.e("diai", "THread: "+Thread.currentThread().getId());
