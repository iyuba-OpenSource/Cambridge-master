/**
 *	Copyright (c) 2016, hehonghui@umeng.com All Rights Reserved.
 */
 ...
 * (TextView)$(viewId); 如果页面中的控件比较多，就会有很多的类型转换,而使用ViewFinder则免去了类型转换,
 * 示例如下 : TextView textView = ViewFinder.$(viewId);
 * 
 * @author mrsimple
 */
