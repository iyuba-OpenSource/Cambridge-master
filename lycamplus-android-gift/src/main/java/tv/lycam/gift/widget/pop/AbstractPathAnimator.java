...
//        return mRandom.nextFloat() * 28.6F + 14.3F;
    ...
    public abstract void start(View child, ViewGroup parent, AnimCallback callback);
    ...
    public static class Config {
        ...
        static Config fromTypeArray(Context context, TypedArray typedArray) {
            Config config = new Config();
            Resources res = typedArray.getResources();
            config.initX = (int) typedArray.getDimension(R.styleable.HeartLayout_initX,
                    ScreenUtil.getScreenWidthInPx(context) - res.getDimensionPixelOffset(R.dimen.heart_anim_init_x));
            ...
            config.xPointFactor = (int) typedArray.getDimension(R.styleable.HeartLayout_xPointFactor,
                    ScreenUtil.getScreenWidthInPx(context) - res.getDimensionPixelOffset(R.dimen.heart_anim_x_point_factor));
