package tv.lycam.gift.widget.span;
...
import tv.lycam.gift.widget.span.customspan.CustomAbsoluteSizeSpan;
import tv.lycam.gift.widget.span.customspan.CustomClickableSpan;
import tv.lycam.gift.widget.span.customspan.CustomImageSpan;
import tv.lycam.gift.widget.span.customspan.CustomLabelSpan;
import tv.lycam.gift.widget.span.other.CustomLinkMovementMethod;
import tv.lycam.gift.widget.span.other.OnClickableSpanListener;
import tv.lycam.gift.widget.span.unit.BaseSpecialUnit;
import tv.lycam.gift.widget.span.unit.SpecialImageUnit;
import tv.lycam.gift.widget.span.unit.SpecialLabelUnit;
import tv.lycam.gift.widget.span.unit.SpecialRawSpanUnit;
            ...
            if (st instanceof SpecialTextUnit) {
                ...
                for (int startPos : specialTextUnit.getStartPoss()) {
                    ...
                    if(specialTextUnit.isShowMask()){
                        ...
                        MaskFilterSpan maskFilterSpan = new MaskFilterSpan(new EmbossMaskFilter(new float[]{10, 10, 10}, 0.5f, 1f, 0.5f));
                        spannableStringBuilder.setSpan(maskFilterSpan,startPos, startPos + specialTextLength, Spanned.SPAN_INCLUSIVE_EXCLUSIVE);
                    }
