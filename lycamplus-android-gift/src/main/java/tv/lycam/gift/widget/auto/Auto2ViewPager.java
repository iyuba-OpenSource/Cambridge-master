package tv.lycam.gift.widget.auto;
 ...
 */
public class Auto2ViewPager extends ViewPager {
    ...
    public Auto2ViewPager(Context paramContext) {
        super(paramContext);
        init();
    }

    public Auto2ViewPager(Context paramContext, AttributeSet paramAttributeSet) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            int h = 2 * child.getMeasuredHeight();
    ...
    private static class MyHandler extends Handler {
        ...
        private final WeakReference<Auto2ViewPager> autoScrollViewPager;

        public MyHandler(Auto2ViewPager autoScrollViewPager) {
            this.autoScrollViewPager = new WeakReference<Auto2ViewPager>(autoScrollViewPager);
        }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case SCROLL_WHAT:
                    Auto2ViewPager pager = this.autoScrollViewPager.get();
                    if (pager != null) {
