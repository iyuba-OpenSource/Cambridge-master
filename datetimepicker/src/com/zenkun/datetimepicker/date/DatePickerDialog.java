...
public class DatePickerDialog extends DialogFragment implements View.OnClickListener, DatePickerController {
	...
	public View onCreateView(LayoutInflater layoutInflater, ViewGroup parent, Bundle bundle) {
		...
		this.mDayOfWeekView = view.findViewById(R.id.date_picker_header);
		this.mMonthAndDayView = view.findViewById(R.id.date_picker_month_and_day);
		this.mMonthAndDayView.setOnClickListener(this);
		this.mSelectedMonthTextView = view.findViewById(R.id.date_picker_month);
		this.mSelectedDayTextView = view.findViewById(R.id.date_picker_day);
		this.mYearView = view.findViewById(R.id.date_picker_year);
		...
		this.mAnimator = view.findViewById(R.id.animator);
