package com.iyuba.camstory.lil;
 ...
 * Version: 1.0.3
 **/
public class OAIDNewHelper implements IIdentifierListener {
    ...
    public String ASSET_FILE_NAME_CERT = ""; // TODO （2）设置 asset证书文件名
    ...
    public OAIDNewHelper(AppIdsUpdater appIdsUpdater, String lib, String certName) {
        // TODO （3）加固版本在调用前必须载入SDK安全库,因为加载有延迟，推荐在application中调用loadLibrary方法
        // System.loadLibrary("msaoaidsec");
        // DemoHelper版本建议与SDK版本一致
        loadLibrary(lib);
        this.ASSET_FILE_NAME_CERT = certName;
        if (isArchSupport) {
