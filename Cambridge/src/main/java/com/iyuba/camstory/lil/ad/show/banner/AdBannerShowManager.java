package com.iyuba.camstory.lil.ad.show.banner;
...
public class AdBannerShowManager {
    ...
    public void showBannerAd() {
        ...
        //请求广告
        AdRemoteManager.getAd(AccountManager.getInstance().getUId(), AdShowUtil.NetParam.Flag.net_bannerFlag, AdShowUtil.NetParam.AppId)
