package com.iyuba.camstory.lil.ad.show.spread;
...
import com.iyuba.camstory.lil.ad.AdDataUtil;
import com.iyuba.camstory.lil.ad.AdLogUtil;
import com.iyuba.camstory.lil.ad.manager.AdRemoteManager;
import com.iyuba.camstory.lil.ad.manager.bean.Ad_result;
import com.iyuba.camstory.lil.ad.show.AdShowUtil;
import com.iyuba.camstory.lil.util.LibGlide3Util;
import com.iyuba.camstory.lil.util.LibRxUtil;
import com.iyuba.camstory.lil.util.ToastUtil;
...
public class AdSpreadShowManager {
    ...
    public void showSpreadAd() {
        ...
        //请求广告
        AdRemoteManager.getAd(AccountManager.getInstance().getUId(), AdShowUtil.NetParam.Flag.net_spreadFlag, AdShowUtil.NetParam.AppId)
