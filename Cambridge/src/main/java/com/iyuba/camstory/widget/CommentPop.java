...
public class CommentPop extends PopupWindow {
    ...
    public CommentPop(final Activity context, View root) {
...
//        this.setAnimationStyle(R.style.AnimationPreview);
        ...
        TextView commit = conentView.findViewById(R.id.commit);
        TextView cancel = conentView.findViewById(R.id.cancel);

        text = conentView.findViewById(R.id.text);
        ...
        commit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    //去评价后标记，再也不弹出好评送书弹框
                    ConfigManagerSet.Instance().putBoolean("firstSendbook",true);
