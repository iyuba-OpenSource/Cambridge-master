...
import com.iyuba.camstory.protocol.view.AmountView;
...
public class ShopCartAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View currentView, ViewGroup arg2) {
        ...
        if (currentView == null) {
            ...
            holderView.content = currentView.findViewById(R.id.book_name);
            holderView.totalPrice = currentView.findViewById(R.id.total_price);
            holderView.av = currentView.findViewById(R.id.amount_view);
            holderView.cb_choice = currentView.findViewById(R.id.cb_choice);
            holderView.img = currentView.findViewById(R.id.iv_adapter_list_pic);
            holderView.numSolid = currentView.findViewById(R.id.amount_solid);
            holderView.numDecrease = currentView.findViewById(R.id.btnDecrease);
            holderView.numIncrease = currentView.findViewById(R.id.btnIncrease);
            holderView.et = currentView.findViewById(R.id.tv_num);
