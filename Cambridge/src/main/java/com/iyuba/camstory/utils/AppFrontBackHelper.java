...
public class AppFrontBackHelper {
    ...
    private static volatile AppFrontBackHelper instance = null;
    ...
    public void setListener(OnAppStatusListener mOnAppStatusListener){
        this.mOnAppStatusListener = mOnAppStatusListener;
    }
