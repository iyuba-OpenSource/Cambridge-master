...
public class NetStatusUtil {
	...
	public static void connectionNetwork(final CommonCallBack callBack) {
		CrashApplication.getInstance().getCostTimeExecutors()
	...
	public static boolean is3G(Context context) {
        ...
        return activeNetInfo != null
                ...
                || activeNetInfo.getSubtype() == TelephonyManager.NETWORK_TYPE_HSPAP || activeNetInfo
                .getSubtype() == TelephonyManager.NETWORK_TYPE_HSUPA);
    }
