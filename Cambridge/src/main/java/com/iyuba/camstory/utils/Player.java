...
public class Player implements OnCompletionListener, OnPreparedListener,
	...
	private static final int STATE_IDLE = 0;//状态闲置
	private static final int STATE_INITIALIZED = 1;
	private static final int STATE_PREPARING = 2;
	private static final int STATE_PREPARED = 3;
	private static final int STATE_PLAYING = 4;
	private static final int STATE_PAUSED = 5;
	private static final int STATE_PLAYBACK_COMPLETED = 6;//状态播放完成
	...
	public boolean isIdle() {
		return mPlayerState == STATE_IDLE ;//|| mPlayerState == STATE_PLAYBACK_COMPLETED
	}
