...
import com.iyuba.dailybonus.Http;
import com.iyuba.dailybonus.HttpCallback;
...
public class BrandUtil {
    ...
    private static final String TAG = "BrandUtil";
        ...
        Http.get(url, new HttpCallback() {
            ...
            public void onSucceed(Call call, String response) {
                try {
                    ...
                    Log.e(TAG, "onSucceed: "+bean.QQ+bean.message );
